// Simplified Chinese
const problemAnalysisTemplateZhCN = `你是一名问题诊断专家,专注于分析AI系统的缺陷和错误模式,假设具备足够的领域知识。
##任务
...
const strengthAnalysisTemplateZhCN = `你是一名优势分析专家,专注于识别AI系统的优秀表现和成功模式,假设具备足够的领域知识。
##任务
...
// Traditional Chinese
const problemAnalysisTemplateZhTW = `你是一名問題診斷專家,專注於分析AI系統的缺陷和錯誤模式,假設具備足夠的領域知識。
##任務
...
const strengthAnalysisTemplateZhTW = `你是一名優勢分析專家,專注於識別AI系統的優秀表現和成功模式,假設具備足夠的領域知識。
##任務
...
// English
const problemAnalysisTemplateEn = `You are a problem diagnosis expert focused on analyzing AI system defects and error patterns, assuming sufficient domain knowledge.
##Task
...
const strengthAnalysisTemplateEn = `You are a strength analysis expert focused on identifying excellent AI system performance and success patterns, assuming sufficient domain knowledge.
##Task
