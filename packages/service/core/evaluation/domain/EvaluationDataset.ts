import { EvaluationDataset as IEvaluationDataset, EvaluationData } from '@fastgpt/global/core/evaluation/type';
import { generateId, validateEvaluationData, validateEvaluationDataset } from '@fastgpt/global/core/evaluation/utils';
...
export class EvaluationDataset implements IEvaluationDataset {
  ...
  constructor(props: Omit<IEvaluationDataset, 'id' | 'created_at' | 'updated_at'> & { id?: string }) {
